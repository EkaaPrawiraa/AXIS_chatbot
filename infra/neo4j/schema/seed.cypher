...
// -----------------------------------------------------------------------------
// SECTION 6: EMOTIONS (intensity + valence)
// Russell (1980) circumplex reduced to the two axes that have live
// readers (context_builder display + DistressSnapshot aggregation).
// PAD arousal/dominance were dropped in 2026-05 with the per-turn
// emotion_detection node (see docs/devnotes).
// -----------------------------------------------------------------------------
...
// do not collide; matches subject_kg.write_subject.
// -----------------------------------------------------------------------------
...
MATCH
  ...
  (subject:Subject  {id: 'subject-seed-001'}),
