"""Graph Reranker -------------- Graph Reranker -------------- Graph Reranker -------------- Graph Reranker -------------- Graph Reranker -------------- Graph Reranker -------------- Graph Reranker -------------- Graph Reranker -------------- Graph Reranker -------------- Graph Reranker --------------"""
...
def graph_rerank(
    ...
    *,
    ...
    """apply_weighted_graph_reranking mutate_scores sort_by_final_score"""
