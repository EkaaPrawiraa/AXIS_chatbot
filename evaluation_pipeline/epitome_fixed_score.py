"""EPITOME scoring for the corrected (contamination-free) axis_full and
axis_vector_only reruns on Arya/Budi, replacing the original ablation-*-20260712
Budi/Arya numbers that were tainted by cross-run finalization contamination."""
...
RUNS = {
    "axis_full": "ablation-axis-full-fixed-20260712",
    "axis_vector_only": "ablation-axis-vectoronly-fixed-20260712",
}
...
def main() -> None:
    ...
    out_path = ROOT / "evaluation_pipeline" / "results" / "epitome_fixed_scores.json"
