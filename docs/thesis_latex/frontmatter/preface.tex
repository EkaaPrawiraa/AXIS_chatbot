...
Laporan Tugas Akhir berjudul \textit{Pengembangan Arsitektur Perangkat Lunak Companionship Chatbot dengan Memori Jangka Panjang Berbasis Knowledge Graph untuk Mahasiswa Indonesia} ini disusun sebagai salah satu syarat untuk memperoleh gelar Sarjana pada Program Studi Teknik Informatika, Sekolah Teknik Elektro dan Informatika, Institut Teknologi Bandung, sekaligus sebagai luaran akhir mata kuliah IF4092 Tugas Akhir II.
...
\item Dr. Agung Dewandaru, S.T., M.Sc. selaku dosen pembimbing yang telah meluangkan waktu untuk memberikan arahan, masukan, dan berbagai diskusi ilmiah selama proses penyusunan tugas akhir ini.
