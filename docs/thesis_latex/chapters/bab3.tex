...
\hline
RM1a: kelayakan respons suportif dan nilai konteks memori & Respons AXIS dan \textit{baseline} pada skenario yang sama & Penilaian buta dengan rubrik ordinal berbasis EPITOME dan dimensi tambahan; median atau distribusi per dimensi; preferensi berpasangan. Hasil tidak digunakan untuk mengklaim keunggulan dialog secara umum. \\
\hline
RM3: memori jangka panjang & Penulisan, \textit{retrieval}, pembaruan, penggunaan, dan ablasi & Metrik yang direalisasikan mencakup presisi dan \textit{recall} penulisan node dan relasi, \textit{P@5}, \textit{Recall@5}, MRR, nDCG@5, \textit{update correctness}, tingkat keberhasilan kueri relasional/kausal dan abstensi, \textit{grounded-answer rate}, \textit{false-personalization rate}, \textit{contradiction rate}, \textit{stale-belief rate}, serta selisih berpasangan dari ablasi terkendali. \\
\hline
