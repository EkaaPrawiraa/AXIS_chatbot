...
% Bab ini menerjemahkan masalah pada BAB I menjadi rancangan solusi yang utuh. Ketiga rumusan masalah tersebut, betapapun berbeda kebutuhan teknisnya, sesungguhnya menuntut satu syarat yang sama: pengguna harus merasa berhadapan dengan satu pendamping yang konsisten, bukan kumpulan fitur yang berdiri sendiri. BAB I menunjukkan bahwa perubahan persona pada pembaruan sistem dapat merusak hubungan yang sudah terbentuk antara pengguna dan chatbot pendampingnya (\textit{identity discontinuity}). Dengan alasan yang sama, chatbot pendamping pada tugas akhir ini memerlukan identitas tunggal yang menjadi titik ikat bagi seluruh kemampuannya, dari percakapan reflektif hingga memori jangka panjang.

% Chatbot pendamping yang dirancang pada tugas akhir ini diberi nama AXIS, diambil dari kata \textit{axis} yang berarti poros atau sumbu. Sebagaimana poros menjadi pusat tempat berbagai bagian berputar tanpa berubah posisi, AXIS diposisikan sebagai titik tetap tempat percakapan reflektif, pemantauan kondisi emosional, dan memori jangka panjang pengguna bertumpu pada satu identitas yang sama. Nama tunggal ini dipakai konsisten pada seluruh rancangan solusi berikut, sehingga pembahasan diarahkan pada alasan mengapa AXIS perlu memiliki percakapan pendamping, pemeriksaan suasana hati, dan memori jangka panjang yang dapat berubah mengikuti pengguna. Rincian mengenai layanan, basis data, alur pemrosesan teknis, dan implementasi perangkat lunak ditempatkan pada BAB IV agar batas antara rancangan dan realisasi tetap jelas.
...
Rumusan masalah kedua menambahkan kebutuhan pemantauan kondisi emosional. Pengguna tidak selalu datang dengan masalah yang siap dijelaskan panjang lebar. Kadang kondisinya hanya tertangkap lewat sinyal ringan seperti sedang sangat sedih, biasa saja, atau cukup baik. Catatan suasana hati harian membantu AXIS membaca nada awal tersebut. Untuk pemantauan yang lebih terstruktur, dipilih instrumen PHQ-9: kuesioner sembilan butir yang dapat diisi sendiri dan telah tervalidasi luas sebagai skrining depresi \parencite{kroenke2001phq9}, termasuk pada populasi Indonesia \parencite{yulia2022phq9indo}, dengan ulasan lebih lengkap pada Subbab~\ref{subsec:phq9-instrumen}. Penyampaiannya tidak boleh terasa seperti formulir yang memutus pengalaman pendampingan, sehingga sistem perlu menawarkannya pada waktu yang wajar, menyampaikannya satu per satu, dan menjelaskan hasilnya sebagai skrining, bukan diagnosis.

Rumusan masalah ketiga menuntut memori jangka panjang. Percakapan dengan mahasiswa tidak dapat dipahami sebagai kumpulan pesan terpisah. Cerita tentang revisi skripsi hari ini bisa berkaitan dengan kegagalan presentasi bulan lalu, komentar dosen pembimbing, ekspektasi keluarga, atau perasaan tertinggal dari teman seangkatan. Jika AXIS hanya mengingat potongan teks yang mirip, hubungan semacam itu mudah hilang. Karena itu, sistem membutuhkan memori yang dapat menulis cerita pengguna, menghubungkannya dengan konteks lain, memperbaruinya ketika pemahaman pengguna berubah, dan memilih kembali memori yang relevan pada percakapan berikutnya.
...
\hline
K1: Percakapan bermakna & Pengguna membutuhkan ruang yang tidak hanya membalas pesan, tetapi memahami emosi, konteks, dan gaya bahasa. & Persona pendamping stabil, refleksi berbasis CBT non-klinis, pengayaan bahasa informal dan bahasa campur. \\
\hline
K2: Mood dan PHQ-9 & Kondisi pengguna perlu dipahami secara ringan harian dan lebih terstruktur secara berkala. & Mood harian sebagai konteks, PHQ-9 sebagai skrining percakapan adaptif. \\
\hline
...
\subsection{Rancangan Mood Harian dan PHQ-9}
...
\begin{figure}[!htbp]
  ...
  \caption[Flowchart mood dan PHQ-9]{\textit{Flowchart} konseptual pemeriksaan mood harian dan PHQ-9 sebagai skrining percakapan bertahap.}
...
Evaluasi dirancang untuk menilai sejauh mana tiga rumusan masalah tidak hanya dijawab pada tingkat gagasan, tetapi juga tampak pada perilaku sistem. Kebutuhan ini tidak dapat dipenuhi oleh satu bentuk pengukuran saja. Sebagian perilaku bersifat diskrit dan dapat diperiksa benar-salahnya, misalnya apakah \textit{guardrail} memblokir sinyal risiko atau apakah memori administratif ikut tersimpan, sehingga cocok diukur secara kuantitatif melalui pengujian fungsional. Sebagian perilaku lain, seperti apakah suatu respons terasa empatik dan personal atau justru generik, bersifat interpretatif dan lebih sesuai dinilai secara kualitatif melalui pembacaan transkrip. Kombinasi metode kuantitatif dan kualitatif semacam ini lazim dipakai pada evaluasi chatbot pendamping, termasuk pada Wysa, yang mengevaluasi keterlibatan pengguna secara kuantitatif sekaligus nilai terapeutik yang dirasakan secara kualitatif \parencite{inkster2018}. Karena itu, evaluasi pada tugas akhir ini dirancang tiga jalur. Jalur pertama adalah evaluasi fungsional, yaitu pemeriksaan kuantitatif apakah alur percakapan, PHQ-9, \textit{guardrail}, penulisan memori, dan pengambilan konteks berjalan sesuai rancangan. Jalur kedua adalah studi kasus ilustratif, yaitu pengamatan kualitatif perilaku AXIS dibanding chatbot generik pada skenario pengguna baru dan pengguna lama, tanpa skrip percakapan tetap sehingga hasilnya belum setara pengukuran terkontrol. Jalur ketiga adalah pengujian pengguna nyata untuk melihat apakah pengalaman tersebut dapat digunakan dan dirasakan membantu oleh mahasiswa, menggabungkan data kuantitatif (skala kegunaan) dan kualitatif (masukan bebas). Pada tahap purwarupa, jalur pertama menjadi bukti implementasi utama, jalur kedua menjadi gambaran kualitatif pendukung, sedangkan jalur ketiga disiapkan sebagai evaluasi lanjutan yang memerlukan partisipan nyata dan tata kelola data yang lebih ketat.

\begin{figure}[!htbp]
  \centering
  \includegraphics[width=0.9\textwidth]{figures/evaluation_three_tracks.pdf}
  \caption[Tiga jalur evaluasi AXIS]{Tiga jalur evaluasi AXIS: evaluasi fungsional, studi kasus ilustratif, dan evaluasi pengguna nyata.}
  \label{fig:evaluation-three-tracks}
\end{figure}

Hubungan antara rumusan masalah, rancangan solusi, indikator keberhasilan, dan evaluasi diringkas pada Tabel \ref{tab:pemetaan-rumusan-rancangan}. Tabel ini menjadi jembatan menuju BAB IV, tempat setiap rancangan diwujudkan dan diuji.

\begin{table}[!htbp]
\centering
\caption{Pemetaan rumusan masalah, indikator keberhasilan, dan evaluasi}
...
\hline
\rowcolor{tableheadgray}
\textbf{Rumusan masalah} & \textbf{Indikator keberhasilan rancangan} & \textbf{Cara evaluasi} \\
\hline
Percakapan empatik dan aman & Respons memvalidasi emosi tanpa klaim klinis, teknik CBT muncul sebagai tawaran yang relevan, bahasa respons mengikuti ragam pengguna, dan risiko tinggi dialihkan ke bantuan yang sesuai. & Evaluasi fungsional \textit{guardrail}/CBT dan evaluasi pengguna terhadap kualitas empati, rasa aman, dan naturalitas bahasa. \\
\hline
Mood harian dan PHQ-9 & Mood harian menjadi konteks percakapan, PHQ-9 berjalan bertahap tanpa memutus alur chat, hasil disampaikan sebagai skrining, dan item risiko memicu batas keselamatan. & Evaluasi tahapan alur PHQ-9, penyimpanan \textit{assessment}, dan persepsi pengguna terhadap alur skrining. \\
\hline
Memori jangka panjang & Sesi yang layak ditulis menjadi memori, relasi antarmemori terbentuk, memori administratif seperti item PHQ-9 tidak ikut tersimpan, memori lama dapat diperbarui, dan konteks relevan dipilih kembali pada sesi baru. & Evaluasi penulisan/pengambilan memori, siklus hidup memori, dan studi kasus ilustratif pengguna baru/lama. \\
\hline
\end{tabularx}
}
\end{table}
