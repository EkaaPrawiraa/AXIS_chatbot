...
Setiap tugas anotasi menggunakan pedoman tertulis yang dapat dijalankan oleh dua konfigurasi model penilai (\textit{LLM-as-judge}) \parencite{liu2023geval,zheng2023judging}. Prosedurnya adalah sebagai berikut.
