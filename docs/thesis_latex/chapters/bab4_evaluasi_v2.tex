...
Fidelity orkestrasi (Tabel~\ref{tab:v2-phq-orchestration}) lulus pada kontrak yang diuji, termasuk mood harian dan pemisahan data administratif melalui kontrak memori. Pemetaan jawaban bebas pada 40 kasus menunjukkan kesesuaian penuh dengan label acuan penilai, termasuk empat kasus klarifikasi dan empat rute item kesembilan. Kesesuaian skor total dengan bentuk mandiri tetap memerlukan partisipan nyata. Kesimpulan RM2 karena itu dibatasi pada fidelity administrasi serta pemetaan bahasa pada korpus uji, bukan kesetaraan metode skrining dengan instrumen mandiri.
...
\hline
Penulisan node & Presisi, \textit{recall}, dan \textit{macro-F1} per tipe & Belum diukur; memerlukan korpus emas node berlabel \\
\hline
Penulisan relasi & Presisi, \textit{recall}, dan \textit{macro-F1} per tipe & Belum diukur; memerlukan korpus emas relasi berlabel \\
\hline
Konteks mahasiswa & Akurasi Topik, Peran Subjek, Pemicu, dan domain & Belum diukur; memerlukan korpus emas domain mahasiswa \\
\hline
