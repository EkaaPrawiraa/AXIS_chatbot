...
% Menyisipkan berkas prompt/skrip sumber apa adanya (Lampiran konfigurasi
% prompt) agar isinya tidak pernah menyimpang dari repositori sumber.
\newcommand{\promptlisting}[2][]{%
  \begingroup
  \VerbatimInput[breaklines=true, breakanywhere=true, fontsize=\scriptsize,
    frame=single, framesep=2mm, xleftmargin=2mm, xrightmargin=2mm, #1]{#2}%
  \endgroup
}
...
\usepackage[
  ...
  citecolor=black,
  urlcolor=black,
  pdftitle={Pengembangan Companionship Chatbot dengan Asesmen Depresi melalui Percakapan dan Memori Jangka Panjang Hibrid Berbasis Knowledge Graph untuk Mahasiswa Indonesia},
