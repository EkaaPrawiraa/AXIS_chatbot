  ...
  return (
    <div className={`fixed inset-0 z-[85] bg-black/40 ${animationClasses.sheetBackdropIn}`} onClick={onClose}>
      ...
      >
        ...
        <div className="mt-4 flex items-center gap-3.5 rounded-[16px] bg-[var(--v2-c-f6ead9)] px-4 py-3">
          <Sprout className="h-[24px] w-[24px] shrink-0 text-[var(--v2-green-secondary)]" />
        ...
        <div className="mt-5 flex items-center gap-3">
          ...
          <button
            onClick={onConfirm}
            disabled={isBusy}
            className="v2-anim-pressable flex h-[52px] flex-1 items-center justify-center gap-2.5 rounded-full bg-[var(--v2-clay)] text-[15.5px] font-bold text-white shadow-[0_14px_26px_-14px_rgba(var(--v2-rgb-c36c45),0.9)] disabled:opacity-60"
          >
