...
function ExpandedMapContent() {
  ...
  const content = (
    <main className="flex h-full w-full flex-col bg-[var(--v2-c-f8f1e7)]">
      <header className="pointer-events-none absolute inset-x-0 top-0 z-20 flex items-start justify-between gap-3 p-4">
        <div className="flex items-start gap-4">
          <button
            ...
            className="v2-anim-pressable pointer-events-auto flex h-[46px] items-center gap-2 rounded-full bg-[var(--v2-bg-light-1)] px-5 text-[15px] font-bold text-[var(--v2-ink)] shadow-[0_10px_22px_-14px_rgba(var(--v2-rgb-464035),0.5)]"
          >
      ...
      <footer className="pointer-events-none absolute inset-x-0 bottom-0 z-20 flex items-end justify-between gap-3 p-4">
        <div className="pointer-events-auto flex h-[46px] items-center gap-1 rounded-full bg-[var(--v2-bg-light-1)] px-2 shadow-[0_10px_22px_-14px_rgba(var(--v2-rgb-464035),0.5)]">
        ...
        <div className="hidden h-[42px] items-center gap-3 rounded-full bg-[var(--v2-bg-light-1)]/95 px-4 text-[12.5px] font-semibold text-[var(--v2-ink)] shadow-[0_10px_22px_-14px_rgba(var(--v2-rgb-464035),0.5)] min-[560px]:flex">
          <span className="flex items-center gap-1.5">
            <Hand className="h-[14px] w-[14px]" /> Geser untuk berpindah
          </span>
          <span className="text-[var(--v2-c-c9c2b2)]">•</span>
          <span className="flex items-center gap-1.5">
            <ZoomIn className="h-[14px] w-[14px]" /> Cubit untuk zoom
          </span>
        </div>

        <div className="hidden rounded-[16px] bg-[var(--v2-bg-light-1)] p-2.5 shadow-[0_10px_22px_-14px_rgba(var(--v2-rgb-464035),0.5)] min-[500px]:block">
  ...
  if (isPortrait && size.width && size.height) {
    ...
    return (
      <div className="fixed inset-0 z-[60] overflow-hidden bg-[var(--v2-c-f8f1e7)]">
        <div
          style={{
            position: 'absolute',
            top: 0,
  ...
  return <div className="fixed inset-0 z-[60] overflow-hidden bg-[var(--v2-c-f8f1e7)]">{content}</div>;
}
